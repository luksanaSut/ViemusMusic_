...
const adminPages = [
    ...
    { name: 'ผู้สนใจและทดลองเรียน', path: '/trial-leads' },
    { name: 'เพิ่มผู้สนใจ', path: '/trial-leads/create' },
    { name: 'เงินเดือน', path: '/payroll' },
    { name: 'ค่ารถอาจารย์', path: '/transport-fees' },
    { name: 'ภาพรวมการเงิน', path: '/finance' },
    { name: 'รายงานการเงิน', path: '/finance/report' },
