        ...
        <div class="form-section d-none" id="dailyRangeModeBox">
            ...
            <div class="special-info-box mb-3">
                ...
                <div>คอร์สนี้กำหนดวันเรียนไว้แล้วตั้งแต่ <strong id="specialDateRangeText">-</strong> —
                    ระบบจะสร้างร่างตารางให้ครบทุกวันในช่วงนี้ ให้ตรวจสอบและแก้ไขได้ในขั้นถัดไป</div>
            </div>
        </div>
    ...
    <script>
        (function() {
            ...
            generateBtn.addEventListener('click', async function() {
                ...
                if (currentMode === 'weekly' && selectedDays.length === 0) {
                ...
                try {
                    ...
                    if (!res.ok) {
                        alert(body.error || 'สร้างตัวอย่างไม่สำเร็จ กรุณาตรวจสอบข้อมูล');
                        return;
                    }
