...
class TeacherSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $teachers = [
            ...
            [
                'teacher_code' => 'T0007',
                'full_name' => 'กิตติพัฒน์ ศรีสมบูรณ์',
                'nickname' => 'กัน',
                'email' => 'kan.bass@viemus.school',
                'phone' => '081-234-5677',
                'employment_type' => 'full_time',
                'branch' => 'Cloud 11',
                'instruments' => ['เบส'],
                'primary_instrument' => 'เบส',
                'teaching_types' => ['สอนประจำ', 'Accompaniment'],
                'levels' => ['เริ่มต้น (Beginner)', 'ปานกลาง (Intermediate)', 'ระดับสูง (Advanced)'],
                'rate_type' => 'per_hour',
                'rate_amount' => 600,
                'bio' => 'มือเบสประจำวงดนตรีสด มีประสบการณ์สอนและเล่นสดมากกว่า 6 ปี',
            ],
            [
                'teacher_code' => 'T0008',
                'full_name' => 'อรวรรณ ทองประเสริฐ',
                'nickname' => 'อร',
                'email' => 'orn.cello@viemus.school',
                'phone' => '081-234-5678',
                'employment_type' => 'freelance',
                'branch' => 'Astra Academy',
                'instruments' => ['เชลโล', 'ไวโอลิน'],
                'primary_instrument' => 'เชลโล',
                'teaching_types' => ['สอนประจำ'],
                'levels' => ['ปานกลาง (Intermediate)', 'ระดับสูง (Advanced)', 'เตรียมสอบ / เตรียมแข่งขัน'],
                'rate_type' => 'per_session',
                'rate_amount' => 750,
                'bio' => 'จบเชลโลจากวิทยาลัยดุริยางคศิลป์ รับสอนเตรียมสอบและเตรียมแข่งขันระดับสูง',
            ],
            [
                'teacher_code' => 'T0009',
                'full_name' => 'ปิยะดา รุ่งเรืองวงศ์',
                'nickname' => 'ปิง',
                'email' => 'ping.flute@viemus.school',
                'phone' => '081-234-5679',
                'employment_type' => 'freelance',
                'branch' => 'Cloud 11',
                'instruments' => ['ขลุ่ย'],
                'primary_instrument' => 'ขลุ่ย',
                'teaching_types' => ['สอนประจำ', 'Workshop'],
                'levels' => ['เริ่มต้น (Beginner)', 'ปานกลาง (Intermediate)'],
                'rate_type' => 'per_hour',
                'rate_amount' => 500,
                'bio' => 'ครูสอนขลุ่ยไทยและขลุ่ยรีคอร์เดอร์ เปิด Workshop ดนตรีไทยเป็นครั้งคราว',
            ],
        ];
