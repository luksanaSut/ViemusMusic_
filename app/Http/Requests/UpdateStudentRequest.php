...
class UpdateStudentRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'school'         => $this->school ? trim(strip_tags($this->school)) : null,
            'phone'          => $this->phone ? preg_replace('/\D/', '', $this->phone) : null,
            'guardian_phone' => $this->guardian_phone ? preg_replace('/\D/', '', $this->guardian_phone) : null,
    ...
    public function rules(): array
    {
        ...
        return [
            'student_code'  => ['required', 'string', 'max:20', 'regex:/^[A-Z0-9\-]+$/', Rule::unique('students', 'student_code')->ignore($studentId)],
            ...
            'guardian_phone'    => ['nullable', 'digits_between:9,10'],
